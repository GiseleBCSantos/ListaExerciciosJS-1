...
def receber_dados(dados_totais, tipo, dados):
    if tipo == "montadoras":
        id = int(ULID())
        nome = input("Insira o nome da montadora: ")
        pais = input("Insira o pais da montadora: ")
        ano_fundacao = int(input("Insira o ano de fundacao da montadora: "))
    ...
    if tipo == 'modelosVeiculos':
        ...
        montadora_id = foreign_key(dados_totais, "montadoras", "id")
    ...
    if tipo == 'veiculos':
        ...
        modelo_id = foreign_key(dados_totais, "modelosVeiculos", "id")
